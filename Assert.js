...
class Assert {
  /**
   * @param {false | {_def: string[], [key: string]: string[]}} settingData 
   */
  constructor(settingData) {
    ...
    this._title = {
      noun: settingData ? settingData.noun || defaultNoun : defaultNoun,
      around: settingData ? settingData.around || defaultAround : defaultAround,
    };
    this._idea = settingData ? settingData.idea || defaultIdea : defaultIdea;
  }
  ...
  static async init() {
    ...
    const fileContent = await new Promise((resolve, reject) =>
      ...
      .catch(_ => {
        console.log("沒有找到設定檔案，程式將使用預設內容。");
        return false;
      })
